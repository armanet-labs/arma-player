...
if (window) {
    ...
    window.setupOutstreamPlayer = function () {
    ...
    window.createOutstreamPlayer = function (el, vastXml, width, height) {
      var videoPlayer = document.createElement('video');
      videoPlayer.preload = true;
      videoPlayer.autoplay = true;
      videoPlayer.muted = true;
      videoPlayer.style = `width:100%;max-width:${width}px;max-height:${height}px`;
      videoPlayer.dataset.outstream = btoa(vastXml);
      el.appendChild(videoPlayer);

      window.setupOutstreamPlayer();
    }
